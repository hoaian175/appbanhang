...
import com.example.cuahang2.adapter.LaptopAdapter;
                ...
                if(response!=null&&response.length()!=2)
                {
                    try {
                        ...
                        for(int i =0;i<jsonArray.length();i++)
                        {
                            ...
                            Idloaisplaptop=jsonObject.getInt("idloaisanpham");
                            manglaptop.add(new Sanpham(Id,Tenlaptop,Gialaptop,Hinhanhlaptop,Motalaptop,Idloaisplaptop));
